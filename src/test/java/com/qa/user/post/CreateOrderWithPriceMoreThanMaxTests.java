...
public class CreateOrderWithPriceMoreThanMaxTests {

    @Story("Price")
    @Test(description = "Create an order with price more than MAX")
    public void createOrderWithPriceMoreThanMax() {

        Order createdOrder = new Order("test", Long.MAX_VALUE + 1);
